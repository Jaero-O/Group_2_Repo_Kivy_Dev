...
class ResultScreen(Screen):
    ...
    def on_enter(self, *args):
        ...
        if record_id is not None:
            ...
            db_manager.get_record_by_id_async(
                record_id,
    ...
    def _fetch_and_populate_details(self):
        ...
        details = db_manager.get_disease_and_severity_details(
    ...
    def _prepare_for_save(self):
        ...
        self._disease_id, self._severity_level_id = db_manager.get_lookup_ids(
            disease_name=self.disease_name,
    ...
    def save_result(self):
        ...
        if self._disease_id is None or self._severity_level_id is None:
            print("Save aborted: Missing disease/severity database IDs.")
            return
        ...
        db_manager.save_record_async(
            ...
            severity_level_id=self._severity_level_id,
            severity_percentage=self._severity_percentage_float,
    ...
    def on_save_success(self, success_flag):
        """Callback for a successful save operation."""
        print("Record saved successfully!")
        self.manager.current = 'save' # Navigate to the confirmation screen

    @mainthread
    def on_save_error(self, error_message):
        """Callback for a failed save operation."""
        print(f"Failed to save record: {error_message}")
