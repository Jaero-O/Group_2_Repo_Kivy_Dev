...
class SystemSpecScreen(Screen):
    description_text = (
        ...
        "stored images and records. It also enables seamless synchronization between the device and "
        "cloud storage, ensuring that all scanned data and results are properly saved for later review "
